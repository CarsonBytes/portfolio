...
| **Adaptive Study Platform** | An AIGP exam-prep tool built for my own certification study: FSRS-scheduled spaced repetition, an epsilon-greedy bandit targeting weak topics, and Supabase + pgvector RAG for grounded AI explanations. | [Live](https://carsonng.short.gy/study-platform-live) · [GitHub](https://carsonng.short.gy/study-platform-github) |
| **Event Radar** | AI-powered event discovery for Hong Kong: two-stage LLM ranking to keep API costs sane, graceful degradation on LLM failures, and a closed personalization feedback loop. | [Live](https://carsonng.short.gy/event-radar-live) · [GitHub](https://carsonng.short.gy/event-radar-github) |
