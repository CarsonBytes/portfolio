                    ...
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            ...
                            <div class="skillset">
                                ...
                                <div class="item">
                                    <h3 class="level-title">AI Governance (NIST AI RMF, EU AI Act, human-in-the-loop design)<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title=""><i class="fas fa-info-circle"></i>Pro</span></h3>
                                    <div class="level-bar progress">
                                        <div class="progress-bar level-bar-inner" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90"></div>
                                    </div>
                                    <!--//level-bar-->
                                </div>
                                <!--//item-->
                                ...
                                <div class="item">
                                    <h3 class="level-title">Python (FastAPI, LangGraph, pandas)<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title=""><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar progress">
                                        <div class="progress-bar level-bar-inner" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90"></div>
                                    </div>
                                    <!--//level-bar-->
                                ...
                                <div class="item">
                                    <h3 class="level-title">AWS & Cloud Infrastructure (Terraform, Docker, Cloudflare)<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title=""><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar progress">
                                        <div class="progress-bar level-bar-inner" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90"></div>
                                    </div>
                                    <!--//level-bar-->
                                ...
                                <div class="item">
                                    <h3 class="level-title">React / TypeScript<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title=""><i class="fas fa-info-circle"></i>Pro</span></h3>
                                    <div class="level-bar progress">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Full-Stack Engineering (PHP, Node.js)<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title=""><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar progress">
                                        <div class="progress-bar level-bar-inner" role="progressbar" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90"></div>
                                    </div>
                                    <!--//level-bar-->
