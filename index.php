            ...
            <div class="row align-items-center" style="padding: 0 30px;">
                <div class="col">
                    ...
                    <div class="profile-content">
                        ...
                        <div class="icons">
                            <a target="_blank" class="fadein" href="https://carsonng.short.gy/capitaine-stack" data-bs-toggle="tooltip" title="My Stack Overflow Profile"><svg class="svg-icon so-icon" aria-hidden="true"><use href="#i-stackoverflow"/></svg></a>
